  ...
  return (
    <div className='w-11/12 max-w-7x1 text-center mx-auto h-screen flex flex-col items-center justify-center gap-4 '>
              ...
              transition={{duration: 0.8, delay: 0.5}}
               className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo max-w-[70rem] mx-auto text-center">Frontend web developer based in Philippines.</motion.h1>
              ...
              transition={{duration: 0.6, delay: 0.7}}
                ...
                <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                    ...
                    href="/TORRE_RESUME.pdf" download
